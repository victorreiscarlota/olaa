# Criando o conteúdo do arquivo texto
content = """
...
1. **Grafo Esparso vs Denso**
   - Em grafos **esparsos** (\(m \approx n\)), listas de adjacência são mais eficientes.
   - Em grafos **densos** (\(m \approx n^2\)), matrizes de adjacência são ideais.
